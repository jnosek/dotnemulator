...
public class EOR_Test
{
    ...
    public void Immediate()
    {
        ...
        var emulator = new TestEmulator([
            EOR.BASE_OP_CODE | AddressMode.Immediate,
            0b0000_0110,
            0xEA
        ])
        {
        ...
        // assert
        Assert.AreEqual(0b0000_0011, emulator.Accumulator);
    ...
    public void ZeroPage()
    {
        // arrange
        var emulator = new TestEmulator([
            EOR.BASE_OP_CODE | AddressMode.ZeroPage,
            0x03,
            0xEA
        ],
        [ (0x3, 0b0000_0110) ])
    ...
    public void ZeroPageX()
    {
        // arrange
        var emulator = new TestEmulator([
            EOR.BASE_OP_CODE | AddressMode.ZeroPageX,
            0x03,
            0xEA
        ],
        [ (0x06, 0b0000_0110) ])
    ...
    public void Absolute()
    {
        // arrange
        var emulator = new TestEmulator([
            EOR.BASE_OP_CODE | AddressMode.Absolute,
            0x00,
            0xC0,
            0xEA
        ],
    ...
    public void AbsoluteX()
    {
        // arrange
        var emulator = new TestEmulator([
            EOR.BASE_OP_CODE | AddressMode.AbsoluteX,
            0x00,
            0xC0,
            0xEA
        ],
        ...
        // assert
        Assert.AreEqual(0b1000_0011, emulator.Accumulator);
        Assert.IsFalse(emulator.Cpu.P.ZeroFlag);
    ...
    public void AbsoluteY()
    {
        // arrange
        var emulator = new TestEmulator([
            EOR.BASE_OP_CODE | AddressMode.AbsoluteY,
            0x00,
            0xC0,
            0xEA
        ],
    ...
    public void IndexedIndirect()
    {
        // arrange
        var emulator = new TestEmulator([
            EOR.BASE_OP_CODE | AddressMode.Indexed_Indirect,
            0x02,
            0xEA
        ],
        // ram
    ...
    public void IndirectIndexed()
    {
        ...
        // rom
        [
            EOR.BASE_OP_CODE | AddressMode.Indirect_Indexed,
            0x02,
            0xEA
        ],
        // ram
