...
public class AND_Test
{
    ...
    public void Immediate()
    {
        ...
        var emulator = new EmulatorBuilder()
            .WithTestKernel([
                AND.BASE_OP_CODE | AccumulatorInstruction.Immediate,
                0b0000_0010,
                0xEA
            ])
            .Build();
    ...
    public void ImmediateWithZeroValue()
    {
        ...
        emulator.Cpu.A.Value = 0b0000_0100;
    ...
    public void ZeroPage()
    {
        ...
        var emulator = new EmulatorBuilder()
            .WithTestKernel([
                AND.BASE_OP_CODE | AccumulatorInstruction.ZeroPage,
                0x03,
                0xEA
            ])
            .WithRam([ (0x3, 0b0000_0010) ])
            .Build();
    ...
    public void ZeroPageX()
    {
        ...
        var emulator = new EmulatorBuilder()
            .WithTestKernel([
                AND.BASE_OP_CODE | AccumulatorInstruction.ZeroPageX,
                0x03,
                0xEA
            ])
            .WithRam([ (0x06, 0b0000_0010) ])
            .Build();
    ...
    public void Absolute()
    {
        ...
        var emulator = new EmulatorBuilder()
            .WithTestKernel([
                AND.BASE_OP_CODE | AccumulatorInstruction.Absolute,
                0x00,
                0xC0,
                0xEA
            ])
    ...
    public void AbsoluteX()
    {
        ...
        var emulator = new EmulatorBuilder()
            .WithTestKernel([
                AND.BASE_OP_CODE | AccumulatorInstruction.AbsoluteX,
                0x00,
                0xC0,
                0xEA
            ])
        ...
        emulator.Cpu.A.Value = 0b1000_0111;
        emulator.Cpu.X.Value = 0x03;
    ...
    public void AbsoluteY()
    {
        ...
        var emulator = new EmulatorBuilder()
            .WithTestKernel([
                AND.BASE_OP_CODE | AccumulatorInstruction.AbsoluteY,
                0x00,
                0xC0,
                0xEA
            ])
            .WithRam([ (0xC006, 0b0000_0010) ])
            .Build();
    ...
    public void IndexedIndirect()
    {
        ...
        var emulator = new EmulatorBuilder()
            .WithTestKernel([
                AND.BASE_OP_CODE | AccumulatorInstruction.Indexed_Indirect,
                0x02,
                0xEA
            ])
            .WithRam([
    ...
    public void IndirectIndexed()
    {
        ...
        var emulator = new EmulatorBuilder()
            .WithTestKernel([
                AND.BASE_OP_CODE | AccumulatorInstruction.Indirect_Indexed,
                0x02,
                0xEA
            ])
            .WithRam([
